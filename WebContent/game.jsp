...
<div>
	<h3>RPG/RTS</h3>
	<div align="center">
			<img class="witcher" alt="더위쳐" src="./games/witcher.jpeg" onclick="witcher()">
			<img class="diavlo" alt="디아블로" src="./games/diavlo.jpeg">
			<img class="horizon" alt="호라이즌제로던" src="./games/horizon.jpeg">
