...
<hr>
<p id = "list" class="center">현재상영작</p>
<hr>
	...
	<table border = "1" class = "point">
		<tr>
			<td>
		<!-- 1위 -->	
				<img src="https://movie-phinf.pstatic.net/20201104_45/160445535053439akc_JPEG/movie_image.jpg?type=f125" 
				alt="도굴"
				onerror="this.src='https://ssl.pstatic.net/static/movie/2012/06/dft_img125x179.png'">
			</td>
			<td>
		<!-- 2위 -->	
				<img src="https://movie-phinf.pstatic.net/20201102_233/1604294237347ur4pS_JPEG/movie_image.jpg?type=f125" 
				alt="노트북"
				onerror="this.src='https://ssl.pstatic.net/static/movie/2012/06/dft_img125x179.png'">
			</td>
			<td>
		<!-- 3위 -->	
				<img src="https://movie-phinf.pstatic.net/20201030_35/1604023296132Ri22P_JPEG/movie_image.jpg?type=f125" 
				alt="나인스 게이트: 아홉 번째 살인"
				onerror="this.src='https://ssl.pstatic.net/static/movie/2012/06/dft_img125x179.png'">
			</td>
			<td>
		<!-- 4위 -->	
				<img src="https://movie-phinf.pstatic.net/20200908_30/1599532022934EKSC5_JPEG/movie_image.jpg?type=f125" 
				alt="마이 리틀 포니 : 레인보우 로드 트립"
				onerror="this.src='https://ssl.pstatic.net/static/movie/2012/06/dft_img125x179.png'">
			</td>
			<td>
		<!-- 5위 -->	
		...
		<!-- 6위 -->	
			...
			<td>
		<!-- 7위 -->	
				<img src="https://movie-phinf.pstatic.net/20201015_115/1602754186816MCs81_JPEG/movie_image.jpg?type=f125" 
				alt="글로리아를 위하여"
				onerror="this.src='https://ssl.pstatic.net/static/movie/2012/06/dft_img125x179.png'">
			</td>
			<td>
		<!-- 8위 -->	
				<img src="https://movie-phinf.pstatic.net/20200922_78/1600751754973iLu5C_JPEG/movie_image.jpg?type=f125" 
				alt="꿀벌과 천둥"
				onerror="this.src='https://ssl.pstatic.net/static/movie/2012/06/dft_img125x179.png'">
			</td>
			<td>
		<!-- 9위 -->	
				<img src="https://movie-phinf.pstatic.net/20201013_213/1602572174689G1VjO_JPEG/movie_image.jpg?type=f125" 
				alt="불의 전차"
				onerror="this.src='https://ssl.pstatic.net/static/movie/2012/06/dft_img125x179.png'">
			</td>
			<td>
		...
		<!-- 1위 -->	
				...
				onblur="jindo.$Element('reserveTooltip1').hide();movieChart.restartTimer();">
				<span class="rank"><em>1위</em></span><br>
				<span class="ico_rating_12">도굴</span>
				</a>
			</td>
			<td>
		<!-- 2위 -->	
				...
				onblur="jindo.$Element('reserveTooltip2').hide();movieChart.restartTimer();">
				<span class="rank"><em>2위</em></span><br>
				<span class="ico_rating_12">노트북</span>
				</a>
			</td>
			<td>
		<!-- 3위 -->	
				...
				onblur="jindo.$Element('reserveTooltip3').hide();movieChart.restartTimer();">
				<span class="rank"><em>3위</em></span><br>
				<span class="ico_rating_12">나인스 게이트: 아홉 번째 살인</span>
				</a>
			</td>
			<td>
		<!-- 4위 -->	
				...
				onblur="jindo.$Element('reserveTooltip4').hide();movieChart.restartTimer();">
				<span class="rank"><em>4위</em></span><br>
				<span class="ico_rating_12">마이 리틀 포니 : 레인보우 로드 트립</span>
				</a>
			</td>
			<td>
		<!-- 5위 -->	
		...
		<!-- 7위 -->	
				...
				onblur="jindo.$Element('reserveTooltip7').hide();movieChart.restartTimer();">
				<span class="rank"><em>7위</em></span><br>
				<span class="ico_rating_12">글로리아를 위하여</span>
				</a>
			</td>
			<td>
		<!-- 8위 -->	
				...
				onblur="jindo.$Element('reserveTooltip8').hide();movieChart.restartTimer();">
				<span class="rank"><em>8위</em></span><br>
				<span class="ico_rating_12">꿀벌과 천둥</span>
				</a>
			</td>
			<td>
		<!-- 9위 -->	
				...
				onblur="jindo.$Element('reserveTooltip9').hide();movieChart.restartTimer();">
				<span class="rank"><em>9위</em></span><br>
				<span class="ico_rating_12">불의 전차</span>
				</a>
			</td>
			<td>
		<!-- 10위 -->	
